...
It uses AES-256-GCM encryption, well this dosent stop fucking dpi with its to stopping me using the database endpoint, they cant see the packets so they call them suspicious 
